...
\LARGE{Лекция 6. Сборка геномов}\\
\normalsize версия \versionnumber (\textcolor{NavyBlue}{draft})}
\date{28 марта, 2016}
\author{\underline{А. Манолов\thanks{МФТИ}} \and Д. Ищенко\footnotemark[1] \and Б. Коварский\footnotemark[1]
...
% let's go
\section{Задача сборки геномов}
\section{OLC-подход}
\section{Подход на графах де Брейна}
\section{Синопсис}
